...
import com.zjm.aclservice.helper.MemuHelper;
import com.zjm.aclservice.helper.PermissionHelper;
import com.zjm.aclservice.mapper.PermissionMapper;
...
//        });
    ...
    //获取全部菜单
    @Override
    public List<Permission> queryAllMenuMS() {
        //1 查询菜单表所有数据
        QueryWrapper<Permission> wrapper = new QueryWrapper<>();
        wrapper.orderByDesc("id");
        List<Permission> permissionList = baseMapper.selectList(wrapper);
    ...
    //============递归删除菜单==================================
    @Override
    public void removeChildByIdMS(String id) {
    ...
    //=========================给角色分配菜单=======================
    @Override
    public void saveRolePermissionRealtionShipMS(String roleId, String[] permissionIds) {
        //roleId角色id
